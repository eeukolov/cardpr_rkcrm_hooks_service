...
**!Внимание! Настройка параметров приложения будет возможна только при остановленной службе лицензирования. Если служба лицензирования запущена, то при запуске настроек приложения появится сообщение об отсутсвующей лицензии.**  
